...
private:
    static int count;
    static std::map<std::string, texSave> savedTextures;
...
public:
    ...
    void use(int textureIndex);//call to bind the texture to the shader, you can call it only once until you use remove()
